...
All the environments are registered in the `uav_indoor` extension. They start
...
import uav_indoor.tasks  # noqa: F401


def main():
    """Print all environments registered in `uav_indoor` extension."""
